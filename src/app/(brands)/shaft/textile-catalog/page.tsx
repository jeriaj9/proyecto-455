...
export default function ShaftCatalogPage() {
    ...
    useEffect(() => {
        async function loadProducts() {
            try {
                const res = await fetch('/data/shaft-textile-products.json');
                if (res.ok) {
                ...
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="hidden md:inline text-xl font-black italic uppercase tracking-tighter">
                            <span className="text-[#e6ef5a]">/</span> {t.common.textileCatalog}
                        </span>
                    </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-12">
                    <div>
                        ...
                        <p className="text-gray-400 max-w-xl">
                            Explore our range of certified textiles designed for safety, comfort, and speed.
                        </p>
                    </div>
                </div>
